...
Registration tested
    ...
    [Tags]  admin
    input text  name:name   vinai
    sleep  1s
    input text  name:mobnumber  9673834512
    sleep  1s
    input text  name:age    21
    sleep  1s
    input text  name:address    6-26 north street
    sleep  1s
    input text  name:dob    08/11/2002
    sleep  1s
    input text  name:place  avalapalli
    sleep  1s
    input text  name:pincode    614204
    sleep  1s
